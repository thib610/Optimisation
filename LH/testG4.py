...
def testing(LH):
    ...
    for i in LH:
        ...
        fichier.close()
    return 0
def genetic(DIM,NBpoint,NBinitialLH,ImpactCross,ImpactMuta,ITEGE):
    LHlist=[]
    FitTab=[]
    ...
    for i in range(0,ITEGE):
       ...
       # plt.pause(0.00001)
    #plt.show()
    return LHlist[FitTab.index(max(FitTab))]

acc=[]
from statistics import mean
ITEGE=200
DIM=20#dimension du cube
NBpoint=5#nombre de point dans le cube
...
acc2=[]
for i in range(0,10):
    LH = genetic(DIM,NBpoint,NBinitialLH,ImpactCross,ImpactMuta,ITEGE)
